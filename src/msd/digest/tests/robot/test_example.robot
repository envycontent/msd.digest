...
#
#  $ bin/test -s msd.digest -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src msd.digest.testing.MSD_DIGEST_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/msd/digest/tests/robot/test_example.robot
#
